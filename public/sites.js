// Add a new domain: append an entry here. Nothing else to change.
// art: inline SVG (viewBox 0 0 200 120, hairline strokes, currentColor).
window.SITE = {
  name: "hardee",
  tagline: "Pages from 20s.",
  sites: [
    {
    ...
    {
      name: "Mailclub", desc: "A snail mail club. Letters, on paper.", url: "https://mailclub.hardee.co.in",
    ...
    {
      name: "Health", desc: "Nutri-score for any food.", url: "https://health.hardee.co.in",
